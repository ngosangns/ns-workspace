/*
 * OKF Bundle Viewer script.
 *
 * Ported verbatim from GoogleCloudPlatform/knowledge-catalog
 *   okf/src/reference_agent/viewer/static/viz.js
 * Licensed under the Apache License, Version 2.0.
 * Copyright Google LLC. See COPYRIGHT.md for attribution details.
 *
 * Consumes the knowledge bundle injected as window.BUNDLE / window.BUNDLE_NAME
 * (OKF shape: { nodes, edges, bodies, types, palette }). Renders a
 * force-directed Cytoscape.js graph plus a detail panel with frontmatter,
 * marked-rendered body, "Cited by" backlinks, search, type filter and
 * switchable layouts. Runs fully client-side over file:// with no backend.
 */
(function () {
