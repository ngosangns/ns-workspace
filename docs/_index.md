...
| Markdown preview editable | [specs/planning/make-markdown-preview-editable.md](./specs/planning/make-markdown-preview-editable.md)                           | implemented | current | current-state | P0       |
...
| --------------------------------------------------------------------------------------------- | ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Markdown preview editable](./specs/planning/make-markdown-preview-editable.md)               | implemented | [Preview web](./features/preview-web.md), [Module preview](./modules/preview.md), [Edit Markdown trong preview](./specs/planning/add-markdown-editing-preview.md) |
...
flowchart LR
  ...
  "features/preview-web.md" --> "specs/planning/make-markdown-preview-editable.md"
  ...
  "modules/preview.md" --> "specs/planning/make-markdown-preview-editable.md"
