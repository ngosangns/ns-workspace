...
<doc-meta status="active" compliance="current-state" priority="P0">
  ...
  <doc-link href="../features/preview-web.html">Preview web</doc-link>
</doc-meta>
```
...
- `doc-title`, `doc-description` và `doc-link` là child hợp lệ của `doc-meta`; không cần wrapper trung gian.
- `doc-link` trong `doc-meta` tạo quan hệ graph kiểu `references` nếu không có `type`.
...
<doc-meta status="active" compliance="current-state">
  ...
  <doc-link href="./modules/preview.html">Module preview</doc-link>
</doc-meta>
...
- Extract links từ `doc-link[href]`, anchor nội bộ và `doc-relation[target]`.
...
- Dùng DOMPurify sanitize với allowlist custom tags và attributes tối thiểu: `doc-meta`, `doc-title`, `doc-description`, `doc-link`, `doc-relation`, `doc-callout`, `doc-diagram`, `doc-code`, `status`, `compliance`, `priority`, `version`, `tone`, `type`, `target`, `href`, `language`, `class`.
...
- HTML fixture có `doc-meta`, `doc-link`, `doc-relation` xuất hiện đúng trong `/api/docs`, `/api/project`, `/api/graph` và `/api/search`.
