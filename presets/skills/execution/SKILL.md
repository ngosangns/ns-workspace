...
- **Báo cáo có diễn giải:** Giải thích ý nghĩa từng nhóm thay đổi: vấn đề xử lý, behavior/contract đổi/giữ, rủi ro, user cần lưu ý gì.
...
4. Diff review loop (xem CONVENTIONS.md).
