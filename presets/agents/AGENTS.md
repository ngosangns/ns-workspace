...
`spawn-claude-code`, dùng để spawn Claude Code process như sub-agent.
...
| `//sf` | Spawn Claude Code sub-agent, rồi fix khi đã đủ bối cảnh. |
...
| `//spe` | Spawn Claude Code sub-agent, tạo plan, rồi execution sau khi được duyệt nếu task cần. |
