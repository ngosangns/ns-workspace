...
`preview` starts a localhost-only web server that reads a project-style `specs/` folder and renders a Notion-like dashboard with the spec list, Markdown preview, sync state, dependency graph, and relationship map.
